...
app.post('/usuario', [verificaToken, verificaRolAdmn], (req, res) => {
...
app.put('/usuario/:id', [verificaToken, verificaRolAdmn], (req, res) => {
...
app.delete('/usuario/:id', [verificaToken, verificaRolAdmn], (req, res) => {
